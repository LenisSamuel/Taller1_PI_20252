...
def statistics_view(request):
    ...
    # ======================== #
    #  Gráfico: Movies/genre   #
    # ======================== #
    movie_counts_by_genre = {}

    for movie in all_movies:
        if movie.genre:  # asumiendo que tu modelo tiene campo genre tipo "Action, Adventure"
    ...
    plt.bar(bar_positions, movie_counts_by_genre.values(), width=bar_width, align='center', color='orange')
